...
.run-history-item { width: 100%; display: grid; gap: 7px; padding: 11px 12px; border: 0; border-bottom: 1px solid #20252e; background: transparent; color: inherit; cursor: pointer; text-align: left; transition: .15s ease; }
.run-history-item:hover { background: #181d26; }.run-history-item.selected { background: rgba(255, 138, 76, .09); box-shadow: inset 3px 0 0 var(--accent); }
...
.run-history-role { color: #d6dde8; font-size: 11px; font-weight: 750; }.run-history-prompt { overflow: hidden; color: var(--muted); font-family: "SFMono-Regular", Consolas, monospace; font-size: 10px; text-overflow: ellipsis; white-space: nowrap; }
