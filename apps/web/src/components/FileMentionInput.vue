...
<style scoped>
.file-mention-input{position:relative;width:100%;min-width:0}.file-mention-control{width:100%}.file-mention-menu{position:absolute;z-index:80;top:calc(100% + 5px);left:0;width:100%;max-height:240px;overflow:auto;border:1px solid var(--border-bright);border-radius:7px;background:var(--panel-raised);box-shadow:0 14px 35px rgba(0,0,0,.28)}.file-mention-option{display:block;width:100%;min-height:32px;padding:7px 10px;border:0;border-bottom:1px solid var(--border-soft);color:var(--text-body);background:transparent;cursor:pointer;font-family:"SFMono-Regular",Consolas,"Liberation Mono",monospace;font-size:10px;text-align:left}.file-mention-option:last-child{border-bottom:0}.file-mention-option:hover,.file-mention-option.selected{color:var(--text);background:var(--surface-active)}.file-mention-status{padding:10px;color:var(--faint);font-size:10px}
</style>
